...
public class ActividadDao {
    ...
    public void addActividad(Actividad act) {
        ...
        jdbcTemplate.update("INSERT INTO actividad (idTipoActividad, estado ,nombre ,descripcion ,duracion ," +
                        "fecha ,minAsistentes ,maxAsistentes, lugar, puntoDeEncuentro ,horaDeEncuentro ,monitor, descuentoAplicado, inscritos) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                ...
                act.getMonitor(), act.getDescuentoAplicado(), act.getInscritos());
    }
    ...
    public void updateActividad(Actividad act) {
        ...
        jdbcTemplate.update("UPDATE actividad SET idTipoActividad=?, estado=?, nombre=?, descripcion=?, duracion=?, fecha=?, " +
                        "minAsistentes=?, maxAsistentes=?, lugar=?, puntoDeEncuentro=?, horaDeEncuentro=?, monitor=?, descuentoAplicado=?, inscritos=? WHERE id=?",
                ...
                act.getPuntoDeEncuentro(), act.getHoraDeEncuentro(), act.getMonitor(),
                act.getDescuentoAplicado(), act.getInscritos(), act.getId());
    }
